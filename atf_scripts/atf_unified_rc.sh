...
#if [ $RC -ne 0 || -z ${RC+x}]; then
# echo "Downloading RC=SET"
# wget http://172.30.23.4:8081/artifactory/OpenSDL_${SDL_FOLDER}/${SDL_BUILD}/${RC}/OpenSDL_${POLICY}.tar.gz
#else
# echo "Downloading RC=UNSET"
...
echo "<html><head><title>ATF ${BRANCH} ${POLICY} Report - Build#${BUILD_NUMBER}</title></head>" >> atf_report.html
