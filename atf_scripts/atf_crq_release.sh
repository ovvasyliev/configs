...
cd aut
TEST_SET=${TEST_SET}
wget http://172.30.23.4:8081/artifactory/OpenSDL_Func_Release/${SDL_BUILD}/OpenSDL_${POLICY}.tar.gz
...
echo "<html><head><title>ATF Release ${POLICY} Report - Build#${BUILD_NUMBER}</title></head>" >> atf_report.html
